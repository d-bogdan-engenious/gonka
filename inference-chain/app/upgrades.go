...
import (
	...
	"github.com/productscience/inference/app/upgrades/v0_2_14_qa40"
	"github.com/productscience/inference/app/upgrades/v0_2_14_qa40b"
...
func (app *App) setupUpgradeHandlers() {
	...
	app.UpgradeKeeper.SetUpgradeHandler(v0_2_14_qa40.UpgradeName, v0_2_14_qa40.CreateUpgradeHandler(app.ModuleManager, app.Configurator(), app.InferenceKeeper))
	app.UpgradeKeeper.SetUpgradeHandler(v0_2_14_qa40b.UpgradeName, v0_2_14_qa40b.CreateUpgradeHandler(app.ModuleManager, app.Configurator(), app.InferenceKeeper))
}
