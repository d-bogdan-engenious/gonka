...
import (
	...
	"github.com/productscience/inference/app/upgrades/v0_2_14b"
...
func (app *App) setupUpgradeHandlers() {
	...
	app.setTrackedUpgradeHandler(v0_2_14b.UpgradeName, v0_2_14b.CreateUpgradeHandler(app.ModuleManager, app.Configurator()))
}
